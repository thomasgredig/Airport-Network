...
plot(g1,vertex.label.cex=.5,edge.color="orange", vertex.size=12, layout=layout_nicely,vertex.color="gray80" )
...
This report was generated in `r getwd()` on `r Sys.Date()`.